...
ggsave("~/Desktop/test.png", PSCall, width = 8, height=5)
```
...
desCompMot <- ggplot(desDF, aes(compMotC3, desChoice, color=incong)) + 
...
ggsave("~/Desktop/test2.png", desCompMot, width = 8, height=5)

# ggplot(desDF, aes(compMotC3, desAP, color=incong)) + 
#   ggdist::stat_halfeye(adjust = .5, width = .7, .width = 0, justification = -.2, point_colour = NA) + 
#   geom_boxplot(width = .2, outlier.shape = NA) + 
#   geom_jitter(width = .05, alpha = .3) + labs(y="Proportion of Desirable Choices",x="Trial Type") + jtools::theme_apa() +
#   facet_wrap(~condition)
