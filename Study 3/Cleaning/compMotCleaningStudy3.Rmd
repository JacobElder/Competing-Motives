...
```{r}
fullTD <- merge(fullTD, indDiff[c("subID", "Party", "Polit", "conf", "decep", "SStatus", "SocClass", "SE","NFC", "ENT", "MemSE", "PrivCSE", "PubCSE", "IdImp", "SGO", "affPol", "AffPol_Dem", "AffPol_Rep")], by = "subID", all.x = T )
```
...
```{r}
fullDf <- merge(cleanRe, indDiff[c("subID", "Party", "Polit", "conf", "decep", "SStatus", "SocClass", "SE","NFC", "ENT", "MemSE", "PrivCSE", "PubCSE", "IdImp", "SGO", "affPol", "AffPol_Dem", "AffPol_Rep")], by = "subID", all.x = T )
```
